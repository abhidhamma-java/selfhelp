...
public enum CustomOauth2Provider {
    KAKAO {
        public ClientRegistration.Builder getBuilder(String registrationId) {
            ClientRegistration.Builder builder = getBuilder(
                    registrationId, ClientAuthenticationMethod.POST, DEFAULT_LOGIN_REDIRECT_URL);
    ...
    private static final String DEFAULT_LOGIN_REDIRECT_URL = "{baseUrl}/api/auth/oauth2/code/{registrationId}";
